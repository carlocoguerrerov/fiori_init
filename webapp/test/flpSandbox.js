			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mgzcgfiori-display": {
								"semanticObject": "mgzcgfiori",
								"action": "display",
								"description": "A Fiori application CG.",
								"title": "cg fiori",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mgz.cgfiori",
									"url": sap.ui.require.toUrl("mgz/cgfiori")
								}
							}
						}
					}
